      ...
      tabs: [
        {
          ...
          fields: [
            ...
            { name: 'description', type: 'richText' },
            {
              ...
              type: 'textarea',
              admin: { description: 'Plain-text marketing description (auto-populated from manufacturer API). Paragraphs separated by blank lines.' },
            },
          ...
          fields: [
            {
              ...
              fields: [
                ...
                { name: 'lubrication', type: 'text' },
                { name: 'fuelSystem', type: 'text' },
                { name: 'ignition', type: 'text' },
                { name: 'starter', type: 'text' },
                { name: 'fuelTank', type: 'text' },
                { name: 'oilCapacity', type: 'text' },
                { name: 'finalDrive', type: 'text' },
