...
export default buildConfig({
  admin: {
    ...
    theme: 'all',
    components: {
      // Custom branding for the admin. Logo shows on /admin/login;
      // Icon shows in the top-left of the admin nav. Both paths are
      // resolved via the importMap (regenerated by
